...
contract HireChain {
    ...
    // Remove or don’t use projectFreelancers if not needed elsewhere
    ...
    function depositFunds(uint _projectId) public payable {
        ...
        require(msg.value == project.bidAmount, "Deposit must match the project amount"); // Update to use bidAmount
