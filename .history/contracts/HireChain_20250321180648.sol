...
contract HireChain {
    ...
    // Constructor removed from here (line 48)
    ...
    // NEW CODE STARTS HERE: Hybrid Completion with Evidence Submission and Dispute Resolution
    ...
    // Updated constructor to set the owner
    ...
    // Temporary function for testing to reset submission status
    function resetSubmission(uint256 _projectId) public onlyOwner {
        submissions[_projectId] = Submission({
